/* ---------------------------------------------------------
   ...
   defines CSV_URLS for a unit, js/sheets-loader.js will fetch that
   unit's lessons from Google Sheets at runtime and use those
   instead — so this file can stay small while the sheet grows.
   See /docs/content-pipeline.md for the full editing workflow.
--------------------------------------------------------- */
const COURSE = {
  units: [
    {
    ...
    { id: "u2",  name: "Statistics I: Describing Data",         desc: "Mean, spread, outliers, and reading a distribution.",              locked: true, guide: "Plutus",    lessons: [] },
    { id: "u3",  name: "Statistics II: Probability & Risk",     desc: "Expected value, volatility, and the traps hiding in the numbers.", locked: true, guide: "Plutus",    lessons: [] },
    { id: "u4",  name: "Reading Financial Statements",          desc: "The three statements, line by line — beyond the basics.",         locked: true, guide: "Ebisu",     lessons: [] },
    { id: "u5",  name: "Comparables & Multiples",                desc: "P/E, EV/EBITDA, and judging a company against its peers.",       locked: true, guide: "Kubera",    lessons: [] },
    { id: "u6",  name: "Discounted Cash Flow Foundations",       desc: "Free cash flow, discount rates, and your first DCF.",            locked: true, guide: "Kubera",    lessons: [] },
    { id: "u7",  name: "Small Business & Rule-of-Thumb Valuation", desc: "Pricing the corner shop and the family business.",             locked: true, guide: "Ebisu",     lessons: [] },
    { id: "u8",  name: "Deals, Mergers & Acquisitions",          desc: "How companies actually get bought and sold.",                    locked: true, guide: "Hermes",    lessons: [] },
    { id: "u9",  name: "IPOs & Capital Markets",                  desc: "How companies go public, and what happens after.",              locked: true, guide: "Hermes",    lessons: [] },
    { id: "u10", name: "Building a Full Valuation Model",        desc: "The capstone of the original 10-unit plan: every earlier lesson, in one working model.", locked: true, guide: "Caishen",   lessons: [] },
    { id: "u11", name: "Unit 11", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u12", name: "Unit 12", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u13", name: "Unit 13", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u14", name: "Unit 14", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u15", name: "Unit 15", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u16", name: "Unit 16", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u17", name: "Unit 17", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u18", name: "Unit 18", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u19", name: "Unit 19", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u20", name: "Unit 20", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u21", name: "Unit 21", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u22", name: "Unit 22", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u23", name: "Unit 23", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Plutus", lessons: [] },
    { id: "u24", name: "Unit 24", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u25", name: "Unit 25", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u26", name: "Unit 26", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u27", name: "Unit 27", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u28", name: "Unit 28", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u29", name: "Unit 29", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u30", name: "Unit 30", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u31", name: "Unit 31", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u32", name: "Unit 32", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u33", name: "Unit 33", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u34", name: "Unit 34", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u35", name: "Unit 35", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u36", name: "Unit 36", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u37", name: "Unit 37", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u38", name: "Unit 38", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u39", name: "Unit 39", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u40", name: "Unit 40", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u41", name: "Unit 41", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u42", name: "Unit 42", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u43", name: "Unit 43", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u44", name: "Unit 44", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u45", name: "Unit 45", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Ebisu", lessons: [] },
    { id: "u46", name: "Unit 46", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u47", name: "Unit 47", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u48", name: "Unit 48", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u49", name: "Unit 49", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u50", name: "Unit 50", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u51", name: "Unit 51", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u52", name: "Unit 52", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u53", name: "Unit 53", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u54", name: "Unit 54", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u55", name: "Unit 55", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u56", name: "Unit 56", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u57", name: "Unit 57", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u58", name: "Unit 58", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u59", name: "Unit 59", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u60", name: "Unit 60", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u61", name: "Unit 61", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u62", name: "Unit 62", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u63", name: "Unit 63", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u64", name: "Unit 64", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u65", name: "Unit 65", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u66", name: "Unit 66", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u67", name: "Unit 67", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Kubera", lessons: [] },
    { id: "u68", name: "Unit 68", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u69", name: "Unit 69", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u70", name: "Unit 70", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u71", name: "Unit 71", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u72", name: "Unit 72", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u73", name: "Unit 73", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u74", name: "Unit 74", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u75", name: "Unit 75", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u76", name: "Unit 76", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u77", name: "Unit 77", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u78", name: "Unit 78", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u79", name: "Unit 79", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u80", name: "Unit 80", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u81", name: "Unit 81", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u82", name: "Unit 82", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u83", name: "Unit 83", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u84", name: "Unit 84", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u85", name: "Unit 85", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u86", name: "Unit 86", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u87", name: "Unit 87", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u88", name: "Unit 88", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u89", name: "Unit 89", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Hermes", lessons: [] },
    { id: "u90", name: "Unit 90", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u91", name: "Unit 91", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u92", name: "Unit 92", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u93", name: "Unit 93", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u94", name: "Unit 94", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u95", name: "Unit 95", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u96", name: "Unit 96", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u97", name: "Unit 97", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u98", name: "Unit 98", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u99", name: "Unit 99", desc: "Planned — title and lessons not written yet.", locked: true, guide: "Caishen", lessons: [] },
    { id: "u100", name: "Unit 100", desc: "Planned — title and lessons not written yet. Capstone unit.", locked: true, guide: "Caishen", lessons: [] },
  ]
};
