/* ---------------------------------------------------------
   DAIKOKUTEN — lesson content (local fallback / seed data)
...
const COURSE = {
  units: [
    ...
    { id: "u10", name: "Building a Full Valuation Model",        desc: "The capstone: every earlier lesson, in one working model.",      locked: true, guide: "Caishen",   lessons: [] }
  ]
};
